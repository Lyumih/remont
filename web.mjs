...
;
	($.$hyoo_search_app) = class $hyoo_search_app extends ($.$mol_book2) {
		Theme(){
		...
		Attribution_loader(){
			const obj = new this.$.$mol_view();
			(obj.dom_name) = () => ("script");
			(obj.attr) = () => ({"src": "https://www.gstatic.com/prose/brand.js", "targetId": "$hyoo_search_app.Root(0).Attribution()"});
			return obj;
		}
		main_content(){
			return [
	...
	($mol_mem(($.$hyoo_search_app.prototype), "Theme"));
	($mol_mem(($.$hyoo_search_app.prototype), "query"));
	($mol_mem(($.$hyoo_search_app.prototype), "submit"));
	($mol_mem(($.$hyoo_search_app.prototype), "Query"));
	($mol_mem(($.$hyoo_search_app.prototype), "exact"));
	($mol_mem(($.$hyoo_search_app.prototype), "Exact_icon"));
	($mol_mem(($.$hyoo_search_app.prototype), "Exact"));
	($mol_mem(($.$hyoo_search_app.prototype), "exclude"));
	($mol_mem(($.$hyoo_search_app.prototype), "Exclude_icon"));
	($mol_mem(($.$hyoo_search_app.prototype), "Exclude"));
	($mol_mem(($.$hyoo_search_app.prototype), "where"));
	($mol_mem(($.$hyoo_search_app.prototype), "Where"));
	($mol_mem(($.$hyoo_search_app.prototype), "type"));
	($mol_mem(($.$hyoo_search_app.prototype), "Type"));
	($mol_mem(($.$hyoo_search_app.prototype), "Settings_open_icon"));
	($mol_mem(($.$hyoo_search_app.prototype), "Settings_open"));
	($mol_mem(($.$hyoo_search_app.prototype), "Error"));
	($mol_mem(($.$hyoo_search_app.prototype), "Result_list_empty"));
	($mol_mem(($.$hyoo_search_app.prototype), "Result_list"));
	($mol_mem(($.$hyoo_search_app.prototype), "Attribution"));
	...
	($mol_mem(($.$hyoo_search_app.prototype), "searchers"));
	($mol_mem(($.$hyoo_search_app.prototype), "Searchers"));
	($mol_mem(($.$hyoo_search_app.prototype), "Searchers_field"));
	($mol_mem(($.$hyoo_search_app.prototype), "blacklist"));
	($mol_mem(($.$hyoo_search_app.prototype), "Blacklist"));
	($mol_mem(($.$hyoo_search_app.prototype), "Blacklist_field"));
	($mol_mem(($.$hyoo_search_app.prototype), "Query_dump"));
	($mol_mem(($.$hyoo_search_app.prototype), "Query_dump_field"));
	($mol_mem(($.$hyoo_search_app.prototype), "Settings_fields"));
	($mol_mem(($.$hyoo_search_app.prototype), "Settings"));
	($mol_mem(($.$hyoo_search_app.prototype), "Sideview_hint"));
	($mol_mem(($.$hyoo_search_app.prototype), "sideview"));
	($mol_mem_key(($.$hyoo_search_app.prototype), "Sideview_embed"));
	($mol_mem_key(($.$hyoo_search_app.prototype), "Result_image"));
	($mol_mem_key(($.$hyoo_search_app.prototype), "Result_title"));
	($mol_mem_key(($.$hyoo_search_app.prototype), "Result_host"));
	($mol_mem_key(($.$hyoo_search_app.prototype), "Result_descr"));
	($mol_mem_key(($.$hyoo_search_app.prototype), "Result_main"));
	($mol_mem_key(($.$hyoo_search_app.prototype), "Result_info"));
	($mol_mem_key(($.$hyoo_search_app.prototype), "Result_ban_icon"));
	($mol_mem_key(($.$hyoo_search_app.prototype), "result_ban"));
	($mol_mem_key(($.$hyoo_search_app.prototype), "Result_ban"));
	($mol_mem_key(($.$hyoo_search_app.prototype), "Result_cache_icon"));
	($mol_mem_key(($.$hyoo_search_app.prototype), "Result_cache"));
	($mol_mem_key(($.$hyoo_search_app.prototype), "Result_open_icon"));
	($mol_mem_key(($.$hyoo_search_app.prototype), "Result_open"));
	($mol_mem_key(($.$hyoo_search_app.prototype), "Result_tools"));
	($mol_mem(($.$hyoo_search_app.prototype), "query_results"));
	($mol_mem_key(($.$hyoo_search_app.prototype), "Sideview"));
	($mol_mem_key(($.$hyoo_search_app.prototype), "Result_item"));
	($mol_mem_key(($.$hyoo_search_app.prototype), "Searcher_link"));
...
;
	...
	($mol_mem(($.$remont_market.prototype), "Find"));
...
;
	($.$remont_app) = class $remont_app extends ($.$mol_book2_catalog) {
		Telegram(){
			const obj = new this.$.$mol_link_iconed();
		...
		GitHub(){
			const obj = new this.$.$mol_link_source();
			(obj.uri) = () => ("https://github.com/Lyumih/remont");
			return obj;
		}
		Thanks(){
			const obj = new this.$.$mol_link_iconed();
		...
		Market(){
			const obj = new this.$.$remont_market();
			return obj;
		}
		Steps(){
			const obj = new this.$.$mol_page();
			(obj.title) = () => ("Первые шаги (В разработке)");
			return obj;
		}
		Tools(){
			const obj = new this.$.$mol_page();
			(obj.title) = () => ("Инструменты (В разработке)");
			return obj;
		}
		Rooms(){
			const obj = new this.$.$mol_page();
			(obj.title) = () => ("Комнаты (В разработке)");
			return obj;
		}
		Likes(){
			const obj = new this.$.$mol_page();
			(obj.title) = () => ("Понравилось (в разработке)");
			return obj;
		}
		Todos(){
			const obj = new this.$.$mol_page();
			(obj.title) = () => ("To do (в разработке)");
			return obj;
		}
		Calculator(){
			const obj = new this.$.$mol_page();
			(obj.title) = () => ("Калькулятор (в разработке)");
			return obj;
		}
		title(){
			return "Мой ремонт";
	...
	($mol_mem(($.$remont_app.prototype), "Telegram"));
	($mol_mem(($.$remont_app.prototype), "GitHub"));
	($mol_mem(($.$remont_app.prototype), "Thanks"));
	($mol_mem(($.$remont_app.prototype), "Market"));
	($mol_mem(($.$remont_app.prototype), "Steps"));
	($mol_mem(($.$remont_app.prototype), "Tools"));
	($mol_mem(($.$remont_app.prototype), "Rooms"));
	($mol_mem(($.$remont_app.prototype), "Likes"));
	($mol_mem(($.$remont_app.prototype), "Todos"));
	($mol_mem(($.$remont_app.prototype), "Calculator"));
